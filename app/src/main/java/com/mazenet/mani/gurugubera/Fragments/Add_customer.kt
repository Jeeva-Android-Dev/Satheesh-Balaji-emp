...
class Add_customer : BaseFragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
      ...
      //  getAgents()
        ...
        agent_spiner.adapter = ArrayAdapter<String>(context,  android.R.layout.simple_spinner_dropdown_item, agent_list)
                ...
                when {
                    response.isSuccessful -> when {
                        response.code().equals(200) -> {
                            ...
                            schemes_spinner.adapter = ArrayAdapter<String>(context,  android.R.layout.simple_spinner_dropdown_item, list)
                    ...
                    response.isSuccessful -> {
                        ...
                        when {
                            response.code().equals(200) -> {
                                ...
                                agent_spiner.adapter = ArrayAdapter<String>(context,  android.R.layout.simple_spinner_dropdown_item, list)
                                agent_spiner.onItemSelectedListener = agetSpinner
                    ...
                    response.isSuccessful -> when {
                        response.code().equals(200) -> {
                          ...
                          //  districtlist = response.body()!!.getdistrict_array() as ArrayList<District_array_Model>
                            ...
                            district_spinner.adapter = ArrayAdapter<String>(context,  android.R.layout.simple_spinner_dropdown_item, list)
                ...
                when {
                    response.isSuccessful -> when {
                        response.code().equals(200) -> {
                            ...
                            city_spinner.adapter = ArrayAdapter<String>(context,  android.R.layout.simple_spinner_dropdown_item, list)
