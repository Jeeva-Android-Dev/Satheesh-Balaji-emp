...
class Before_enroll_ReceiptFragment : BaseFragment() {
    ...
    override fun onCreateView(
        ...
        (activity as HomeActivity).setActionBarTitle("Before Enroll Receipt")
        ...
        view.btn_generatereceipt.setText("Advance Enroll Receipt")
        //=----------------
