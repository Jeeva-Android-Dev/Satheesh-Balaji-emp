...
class GroupFragment : BaseFragment() {
    ...
    override fun onCreateView(
        ...
        custid = arguments!!.getString("cust_id")
        ...
        try {
            ...
            custcode = arguments!!.getString("cust_code")
        } catch (e: Exception) {
            custcode = " "
        }
        try {
            custmobile = arguments!!.getString("cust_mobile")
        } catch (e: Exception) {
            custmobile = " "
        }
        try {
            custphone = arguments!!.getString("cust_phone")
        } catch (e: Exception) {
            custphone = " "
        }
